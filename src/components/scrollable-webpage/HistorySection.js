        ...
        <div className='flex flex-col items-center py-4'>
          ...
          <div className="flex flex-col items-center justify-center mx-4 lg:flex-row lg:mr-[100px]">
            ...
            <div className='flex flex-col space-y-5 w-[300px] lg:w-fit lg:space-y-14'>
              <div className='flex flex-col text-2xl font-black text-right mt-10 lg:mt-14 lg:space-y-14'>
              ...
              <p className='text-lg lg:text-[46px] font-bold text-right font-kumbh lg:leading-[48px]'>The Central Asian Shepherd Dog, also known as Alabay, has been a guardian of livestock and property for centuries. Originating from Central Asia, these dogs are renowned for their courage, strength, and loyalty.</p>
            </div>
          </div>
        </div>
      </section>
