            ...
            <div className='relative flex items-center justify-center rounded-[50px] overflow-clip mx-4 w-full lg:w-[95%] lg:mt-48 border-white border-[14px] my-4'>
                <div className='relative'>
                    <Link to={currentGame.link} target="_blank" rel="noopener noreferrer">
                        ...
                        <button className={`flex items-center space-x-1 py-3 px-6 lg:space-x-11 lg:py-9 lg:px-[78px] ${currentGame.id === 1 ? 'bg-[#843AFC]' : 'bg-[#45D689]'} rounded-[100px] shadow-[12px_11px_11.3px_0px_#0000009C] absolute top-[80%] left-1/2 -translate-y-[80%] -translate-x-1/2`}>
